...
const { loadImage, createCanvas } = require("canvas");
 ...
 return api.sendMessage({ body: ` 💖✨ Congratulations, ${name1}! ✨💖 \ ❤️ Destiny has woven a beautiful story with you and ${name2}! ❤️ \ 🔗 Your hearts are linked with a strong ${tile}% connection! 🔗 `,
 mentions: [{
 tag: `${name2}`,
 id: id2
